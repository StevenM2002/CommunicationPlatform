...
def test_work_dummy_data():
	clear_v1()
	assert channels_listall_v1(1) == {"channels": [{"channel_id": 1, "name": "first_channel"}, {"channel_id": 2, "name": "second_channel"}]}
...
def test_one_channel_public():
	...
	assert channels_listall_v1(auth_id["auth_user_id"]) == {"channels": [{"channel_id": ch_id["channel_id"], "name": "first channel"}]}
...
def test_two_channels():
	clear_v1()
	auth_id1 = auth_register_v1("firstid@gmail.com", "password", "firstname", "lastname")
	auth_id2 = auth_register_v1("secondid@gmail.com", "password", "firstname", "lastname")
	...
	assert channels_listall_v1(auth_id1["auth_user_id"]) == {"channels": [
...
def test_mixed():
	...
	auth_id1 = auth_register_v1("firstid@gmail.com", "password", "firstname", "lastname")
	auth_id2 = auth_register_v1("secondid@gmail.com", "password", "firstname", "lastname")
	auth_id3 = auth_register_v1("thirdid@gmail.com", "password", "firstname", "lastname")
	auth_id4 = auth_register_v1("fourthid@gmail.com", "password", "firstname", "lastname")
	auth_id5 = auth_register_v1("fifthid@gmail.com", "password", "firstname", "lastname")
	auth_id6 = auth_register_v1("sixthid@gmail.com", "password", "firstname", "lastname")
	ch_id1 = channels_create_v1(auth_id1["auth_user_id"], "first channel", True)
